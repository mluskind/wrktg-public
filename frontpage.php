      ...
      <ul class="thumbnails example-sites">
        <li class="span3">
          <a class="thumbnail" href="http://homewood.org/" target="_blank">
            <img src="<?php echo get_stylesheet_directory_uri() ?>/images/Homewood.png" alt="Homewood">
          </a>
        </li>
        <li class="span3">
          <a class="thumbnail" href="http://dhltd.com/" target="_blank">
            <img src="<?php echo get_stylesheet_directory_uri() ?>/images/dnh.png" alt="Davis and Henderson">
          </a>
        </li>
        <li class="span3">
          <a class="thumbnail" href="http://no-kidding.ichannel.ca/" target="_blank">
            <img src="<?php echo get_stylesheet_directory_uri() ?>/images/ichannel.png"
                 alt="No Kidding - ichannel">
          </a>
        </li>
        <li class="span3">
          <a class="thumbnail" href="http://nobelwomensinitiative.org/" target="_blank">
            <img src="<?php echo get_stylesheet_directory_uri() ?>/images/nwi.png"
